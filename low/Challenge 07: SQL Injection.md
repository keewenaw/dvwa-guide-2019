...
<ul>
  <li><code>--wordlist=[wordlist_file]</code>: We already had the "rockyou" wordlist from <a href="https://github.com/mrudy/dvwa-guide-2019/blob/master/low/Challenge%2001:%20Brute%20Force.md" target="_blank">Challenge 1</a>. We'll be using that again.</li>
